...
#define LCD_DATA	1
	...
	#define LCD_DATA_PIN_7 			LCD_Pin7_Lat
	#define LCD_DATA_PIN_6 			LCD_Pin6_Lat
	#define LCD_DATA_PIN_5 			LCD_Pin5_Lat
	#define LCD_DATA_PIN_4 			LCD_Pin4_Lat
		
	#define LCD_READ_PIN_7			LCD_Pin7
	#define LCD_READ_PIN_6			LCD_Pin6
	#define LCD_READ_PIN_5			LCD_Pin5
	#define LCD_READ_PIN_4			LCD_Pin4
				
	#define LCD_TRIS_DATA_PIN_7     LCD_Pin7_Tris
	#define LCD_TRIS_DATA_PIN_6     LCD_Pin6_Tris
	#define LCD_TRIS_DATA_PIN_5     LCD_Pin5_Tris
	#define LCD_TRIS_DATA_PIN_4     LCD_Pin4_Tris
		
	#define LCD_E_PIN	LCD_PinE_Lat 
	#define LCD_RS_PIN	LCD_PinRS_Lat 
	#ifdef LCD_USE_RW
		#define LCD_RW_PIN	LCD_PinRW_Lat 
	#endif
		
	#define LCD_TRIS_E	LCD_PinE_Tris
	#define LCD_TRIS_RS	LCD_PinRS_Tris  
	#ifdef LCD_USE_RW 
		#define LCD_TRIS_RW	LCD_PinRW_Tris 
	#endif 
#else
